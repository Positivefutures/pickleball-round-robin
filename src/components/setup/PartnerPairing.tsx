...
export function PartnerPairing({
  ...
  // What pairing everyone up does to the session is said by PartnerPlayNotice,
  // which SetupPage draws above this panel. It used to be in here, and went away
  // with the rest of this mode the moment Done Pairing was pressed.
