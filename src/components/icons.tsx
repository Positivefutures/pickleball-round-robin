...
/**
 * A cog with a return hook swung under it: going back to a tab already left.
 *
 * `INBOX/revert-gear.svg` verbatim, so it keeps the 574x598 grid it was drawn on
 * rather than the 24 most of this file uses. Two things changed: the fills are
 * dropped so it takes the surrounding text colour, and the exporter's
 * `-5.68e-14` coordinates are written as the zero they are.
 *
 * Heads the dialog asking whether to abandon a schedule, where the question is
 * not "are you sure" but "shall we go back", and the cog says which tab.
 */
export function SetupReturnIcon({ className }: { className?: string }) {
  return (
    <Solid className={className} viewBox="0 0 574 598">
      <path
        d="M259,0 C289.879,0 315,25.121 315,56 L315,76.133 C329.785,82.41 343.73,90.506 356.651,100.316 L374.205,90.181 C401.055,74.681 435.297,84.002 450.702,110.677 L470.703,145.319 C486.141,172.063 476.945,206.379 450.205,221.817 L433.243,231.61 C434.422,240.226 435,248.279 435,256 C435,263.719 434.422,271.771 433.243,280.389 L450.205,290.182 C473.177861,303.447668 483.20173,330.644721 475.780802,355.000455 L431.256,355 L436.062,346.678 C440.473,339.039 437.845,329.234 430.204,324.821 L401.244,308.101 C393.91,303.866 390.038,295.472 391.577,287.145 L392.091,284.366 C394.049,273.79 395,264.513 395,256 C395,247.485 394.049,238.207 392.091,227.635 L391.576,224.851 C390.037,216.523 393.909,208.129 401.243,203.895 L430.204,187.174 C437.844,182.763 440.471,172.957 436.06,165.316 L416.061,130.677 C411.713,123.148 401.966,120.34 394.203,124.821 L364.715,141.846 C357.381,146.081 348.176,145.237 341.736,139.742 L339.587,137.909 C325.02,125.483 308.652,115.979 290.938,109.663 L288.282,108.715 C280.317,105.875 275,98.333 275,89.877 L275,56 C275,47.177 267.822,40 259,40 L219,40 C210.178,40 203,47.177 203,56 L203,89.877 C203,98.333 197.683,105.875 189.716,108.715 L187.06,109.662 C169.347,115.978 152.979,125.482 138.412,137.908 L136.263,139.742 C129.822,145.237 120.617,146.08 113.284,141.846 L83.795,124.821 C76.062,120.356 66.306,123.114 61.937,130.679 L41.938,165.318 C37.527,172.958 40.154,182.764 47.795,187.175 L76.756,203.896 C84.09,208.131 87.962,216.525 86.423,224.852 L85.909,227.631 C83.951,238.207 83,247.485 83,256 C83,264.513 83.951,273.79 85.911,284.361 L86.426,287.145 C87.965,295.473 84.093,303.867 76.759,308.101 L47.798,324.821 C40.159,329.233 37.531,339.038 41.941,346.678 L61.941,381.319 C66.303,388.872 76.056,391.647 83.796,387.177 L113.286,370.15 C120.619,365.915 129.828,366.76 136.269,372.258 L138.418,374.092 C152.975,386.514 169.341,396.017 187.064,402.337 L189.72,403.285 C197.685,406.125 203.002,413.667 203.002,422.123 L203.002,456 C203.002,464.823 210.18,472 219.002,472 L259.002,472 C261.122024,472 263.147109,471.585532 265.000453,470.833356 L265.001061,511.680737 C263.02917,511.891753 261.026991,512 259,512 L219,512 C188.121,512 163,486.879 163,456 L163,435.867 C148.208,429.589 134.264,421.493 121.346,411.683 L103.795,421.816 C76.996,437.292 42.73,428.047 27.297,401.32 L7.297,366.678 C-8.141,339.938 1.055,305.622 27.793,290.181 L44.756,280.388 C43.578,271.772 43,263.719 43,256 C43,248.28 43.578,240.227 44.757,231.609 L27.795,221.816 C1.055,206.379 -8.141,172.062 7.296,145.32 L27.297,110.678 C42.751,83.917 77.03,74.73 103.794,90.18 L121.349,100.315 C134.27,90.505 148.215,82.409 163,76.132 L163,56 C163,25.121 188.121,0 219,0 L259,0 Z M239,156 C294.141,156 339,200.86 339,256 C339,311.14 294.141,356 239,356 C183.86,356 139,311.14 139,256 C139,200.86 183.859,156 239,156 Z M239,196 C205.916,196 179,222.916 179,256 C179,289.084 205.916,316 239,316 C272.084,316 299,289.084 299,256 C299,222.916 272.084,196 239,196 Z"
      />
      <g transform="translate(427.5, 456.5) rotate(90) translate(-427.5, -456.5)translate(286, 310)">
        <path d="M6.05299907,228.231579 L64.9582104,287.139995 C68.6590635,290.841038 73.9019322,293 79.453212,293 C84.6960865,293 89.9389725,290.841062 93.9482255,287.139995 L152.853443,228.231579 C160.871948,220.212636 160.871948,207.567378 152.853443,199.548411 C144.834937,191.529469 132.190356,191.529469 124.171851,199.548411 L99.1910884,223.605263 L99.1910884,86.0494725 C99.1910884,60.7589495 119.545764,40.403156 144.834914,40.403156 L196.646812,40.403156 C221.93595,40.403156 242.290649,60.7589437 242.290649,86.0494725 L242.290649,272.644209 C242.290649,283.747368 251.234377,293 262.645325,293 C273.747873,293 283,284.055785 283,272.644215 L283,86.0494783 C283,38.5526316 244.141094,0 196.646836,0 L144.834914,0 C97.3406675,0 58.7901256,38.5526316 58.7901256,86.0494725 L58.7901256,223.605263 L34.7345972,199.548411 C30.7253415,195.538928 25.48247,193.688407 20.2395985,193.688407 C14.996727,193.688407 9.75385243,195.538929 5.74459822,199.548411 C-1.96551029,207.567378 -1.96551029,220.212636 6.05299907,228.231579 Z" />
      </g>
    </Solid>
  );
}
...
/**
 * A pencil writing on a page. `INBOX/edit.svg`. New Round Robin.
 *
 * It replaced a replay arrow, which said "do that again" when the card does the
 * opposite: it puts the schedule down and takes you back to the players to
 * build a different afternoon. A pencil is the shape for starting something.
 */
export function EditPageIcon({ className }: { className?: string }) {
  return (
    <Solid className={className}>
      <path d="m7.56 12.66-.78 2.34a1.74 1.74 0 0 0 .42 1.8 1.75 1.75 0 0 0 1.8.42l2.35-.78a.79.79 0 0 0 .29-.18l10.6-10.61a1.75 1.75 0 0 0 0-2.47l-1.42-1.42a1.75 1.75 0 0 0 -2.47 0l-10.61 10.61a.79.79 0 0 0 -.18.29zm11.85-9.84a.26.26 0 0 1 .35 0l1.42 1.42a.26.26 0 0 1 0 .35l-1.59 1.59-1.77-1.77zm-11.21 12.66.73-2.18 7.83-7.83 1.77 1.77-7.83 7.83-2.18.73a.25.25 0 0 1 -.32-.32zm14.55-5v8.52a3.75 3.75 0 0 1 -3.75 3.75h-14a3.75 3.75 0 0 1 -3.75-3.75v-14a3.75 3.75 0 0 1 3.75-3.75h8.51a.75.75 0 0 1 0 1.5h-8.51a2.25 2.25 0 0 0 -2.25 2.25v14a2.25 2.25 0 0 0 2.25 2.25h14a2.25 2.25 0 0 0 2.25-2.25v-8.51a.75.75 0 0 1 1.5 0z" />
    </Solid>
  );
}

/** A raised palm inside a broken ring. `INBOX/stop.svg`. Stop Sharing. */
export function StopIcon({ className }: { className?: string }) {
  return (
    <Solid className={className} viewBox="0 0 512.78 512.78">
      <path d="m437.686 75.094c-48.425-48.425-112.811-75.094-181.296-75.094-58.613 0-113.784 19.253-159.547 55.677-3.241 2.58-3.777 7.298-1.198 10.539 2.58 3.242 7.299 3.777 10.539 1.198 43.081-34.29 95.021-52.414 150.206-52.414 64.479 0 125.097 25.109 170.689 70.701s70.701 106.211 70.701 170.689-25.109 125.097-70.7 170.69c-45.592 45.592-106.211 70.701-170.689 70.701s-125.098-25.11-170.69-70.701c-45.592-45.593-70.701-106.211-70.701-170.69 0-61.998 23.462-120.924 66.065-165.925 2.848-3.008 2.718-7.755-.29-10.603s-7.755-2.718-10.603.29c-45.251 47.799-70.172 110.388-70.172 176.238 0 68.485 26.669 132.871 75.094 181.296s112.811 75.094 181.296 75.094 132.871-26.669 181.296-75.094 75.094-112.811 75.094-181.296-26.669-132.87-75.094-181.296z" />
      <path d="m329.903 429.776c-3.81 1.625-5.582 6.03-3.957 9.841 1.215 2.851 3.987 4.56 6.902 4.56.981 0 1.979-.194 2.938-.603 36.249-15.456 67.113-40.96 89.256-73.757 22.706-33.629 34.708-72.853 34.707-113.43 0-38.801-10.98-76.538-31.752-109.132-2.205-3.459-5.814-5.699-9.902-6.146-4.114-.45-8.151.969-11.077 3.895l-29.258 29.258c-2.929 2.929-2.929 7.678 0 10.606 2.929 2.929 7.678 2.929 10.606 0l27.975-27.974c18.591 29.819 28.407 64.177 28.408 99.494 0 37.574-11.113 73.895-32.139 105.036-20.521 30.396-49.121 54.032-82.707 68.352z" />
      <path d="m174.451 388.178c-2.929-2.929-7.678-2.929-10.606 0l-18.84 18.841c-2.926 2.925-4.346 6.962-3.896 11.077.448 4.089 2.688 7.698 6.147 9.902 32.594 20.772 70.332 31.752 109.133 31.752 15.41 0 30.782-1.746 45.688-5.189 4.036-.932 6.552-4.959 5.62-8.996-.933-4.036-4.958-6.555-8.996-5.62-13.801 3.188-28.037 4.804-42.313 4.804-35.317 0-69.676-9.816-99.496-28.408l17.557-17.558c2.931-2.928 2.93-7.677.002-10.605z" />
      <path d="m365.524 84.782c-32.593-20.772-70.331-31.752-109.133-31.752-.003 0 .002 0-.001 0-54.178 0-105.213 21.193-143.69 59.67-38.479 38.479-59.67 89.51-59.669 143.691 0 38.801 10.979 76.539 31.751 109.132 2.205 3.459 5.813 5.7 9.902 6.147.502.055 1.002.082 1.5.082 3.583 0 7.009-1.408 9.578-3.977l36.008-36.008c2.929-2.929 2.929-7.678 0-10.606-2.929-2.929-7.678-2.929-10.606 0l-34.725 34.724c-18.592-29.819-28.408-64.178-28.408-99.495 0-50.175 19.63-97.439 55.276-133.084 35.646-35.646 82.909-55.277 133.084-55.277 35.315 0 69.677 9.818 99.496 28.408l-23.558 23.558c-2.929 2.929-2.929 7.678 0 10.606 2.929 2.929 7.678 2.929 10.606 0l24.841-24.841c2.925-2.925 4.345-6.963 3.895-11.078-.447-4.087-2.689-7.696-6.147-9.9z" />
      <path d="m345.214 188.27c-4.841 0-9.4 1.22-13.393 3.365v-38.039c0-15.656-12.737-28.393-28.393-28.393-4.956 0-9.618 1.28-13.677 3.521-1.942-13.778-13.803-24.413-28.108-24.413-15.656 0-28.393 12.737-28.393 28.393v13.529c-3.992-2.145-8.552-3.365-13.393-3.365-15.656 0-28.393 12.737-28.393 28.393v57.816c-7.396-9.025-19.686-13.075-31.556-9.422-7.484 2.304-13.631 7.483-17.309 14.583-3.699 7.141-4.43 15.574-2.019 23.181l16.412 64.482c.022.087.046.175.072.261 4.727 16.12 12.883 32.105 22.966 45.012 16.758 21.45 44.803 36.09 76.945 40.168 5.97.757 11.902 1.135 17.774 1.135 9.034 0 17.924-.895 26.575-2.682 7.328-1.513 14.334-3.651 20.826-6.354 32.218-13.418 51.453-44.841 51.453-84.055v-98.723c.004-15.656-12.733-28.393-28.389-28.393zm13.393 127.116c0 33.443-15.389 59.033-42.22 70.208-5.611 2.337-11.698 4.191-18.093 5.511-12.652 2.614-25.917 3.07-39.428 1.356-28.247-3.583-52.672-16.166-67.012-34.521-8.918-11.416-16.144-25.571-20.356-39.873-.263-1.032-2.187-8.594-16.435-64.573-.041-.162-.088-.323-.14-.482-1.268-3.874-.904-8.202.999-11.874 1.812-3.498 4.796-6.036 8.403-7.147 7.513-2.314 15.369 1.626 18.024 8.983l12.099 49.42c.921 3.765 4.558 6.209 8.395 5.634 22.844-3.422 46.875 12.165 52.474 34.028 1.028 4.012 5.11 6.434 9.126 5.405 4.012-1.028 6.432-5.114 5.405-9.126-3.646-14.237-12.976-26.8-26.27-35.373-11.091-7.152-23.694-10.738-36.088-10.378l-1.023-111.322c0-7.385 6.008-13.393 13.393-13.393s13.393 6.008 13.393 13.393v79.35c0 4.142 3.358 7.5 7.5 7.5s7.5-3.358 7.5-7.5v-79.35-38.557c0-7.385 6.008-13.393 13.393-13.393s13.393 6.008 13.393 13.393v117.905c0 4.142 3.358 7.5 7.5 7.5s7.5-3.358 7.5-7.5v-97.014c0-7.385 6.008-13.393 13.393-13.393s13.393 6.008 13.393 13.393v97.014c0 4.142 3.358 7.5 7.5 7.5s7.5-3.358 7.5-7.5v-33.947c0-7.385 6.008-13.393 13.393-13.393s13.393 6.008 13.393 13.393v98.723z" />
    </Solid>
  );
}

/** A play triangle inside a rewind ring. `INBOX/replay.svg`. Unused since the
 *  New Round Robin card took the pencil above; kept because it is the only
 *  replay shape the app has. */
...
/**
 * Three sliders, each with its handle at a different stop.
 *
 * `INBOX/settings2.svg`, stripped of its wrapping `<g>`s and its Illustrator
 * preamble. Heads Settings, in the side menu and again on the panel it opens:
 * a cog would say the app is being configured, and what is behind this is a
 * short list of things being set to taste.
 */
