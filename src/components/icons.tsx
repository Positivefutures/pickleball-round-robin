...
/**
 * Two people with an arrow curving from one to the other. Add a Sub, where
 * somebody steps in and somebody steps out. Drawn to match `INBOX/Actions.PNG`,
 * which supplied no file for this one.
 */
export function SwapPeopleIcon({ className }: { className?: string }) {
  return (
    <Solid className={className}>
      <path d="M6 11.2c1.6 0 2.9-1.3 2.9-2.9S7.6 5.4 6 5.4 3.1 6.7 3.1 8.3 4.4 11.2 6 11.2zm0 1.5c-2.2 0-5 1.1-5 3.3V18h10v-2c0-2.2-2.8-3.3-5-3.3z" />
      <path d="M18 11.2c1.6 0 2.9-1.3 2.9-2.9S19.6 5.4 18 5.4s-2.9 1.3-2.9 2.9 1.3 2.9 2.9 2.9zm0 1.5c-2.2 0-5 1.1-5 3.3V18h10v-2c0-2.2-2.8-3.3-5-3.3z" />
      <path d="M8.9 2.4a.9.9 0 0 0 0 1.3l.4.4H8A5.2 5.2 0 0 0 3.4 6.9a.9.9 0 1 0 1.6.8A3.4 3.4 0 0 1 8 5.9h1.3l-.4.4a.9.9 0 0 0 1.3 1.3l1.9-1.9a.9.9 0 0 0 0-1.3l-1.9-1.9a.9.9 0 0 0-1.3 0zM15.1 2.4a.9.9 0 0 1 1.3 0l1.9 1.9a.9.9 0 0 1 0 1.3l-1.9 1.9a.9.9 0 1 1-1.3-1.3l.4-.4H14a3.4 3.4 0 0 0-3 1.8.9.9 0 1 1-1.6-.8A5.2 5.2 0 0 1 14 4.1h1.5l-.4-.4a.9.9 0 0 1 0-1.3z" />
    </Solid>
  );
}
...
/** A pencil. `INBOX/pencil.svg`. Badges the star on Edit Player Rating. */
