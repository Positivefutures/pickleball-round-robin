...
export function DefaultRatingPanel({ rating, onChange, onClose }: Props) {
  return (
    ...
    >
      <div
        className={`mx-4 w-full max-w-sm ${panelCard} bg-white p-6`}
      ...
      >
        ...
        <button
          type="button"
          onClick={onClose}
          className="mt-6 w-full rounded-md bg-brand-teal px-4 py-2.5 font-bold text-white transition-colors hover:bg-brand-teal-dark"
        >
          Done
        </button>
      </div>
