        ...
        {sent ? (
          ...
          <>
            ...
            <button
              ...
              disabled={sending}
              className="mt-5 w-full rounded-md bg-brand-teal px-4 py-2.5 font-bold text-white transition-colors hover:bg-brand-teal-dark disabled:cursor-not-allowed disabled:opacity-50"
            >
